...
import { FileTextOutlined, CheckCircleOutlined, BarChartOutlined } from '@ant-design/icons';
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col">
      ...
      <section className="flex-1 flex flex-col justify-center items-center text-center px-6 py-16 md:py-24">
        ...
        <motion.p
          ...
          การจัดการข้อมูลเคลมทั้งหมดในระบบออนไลน์ พร้อมแจ้งเตือนผ่านช่องทาง Telegram
          และสรุปรายงานในรูปแบบของ Dashboard เรียลไทม์
        </motion.p>
